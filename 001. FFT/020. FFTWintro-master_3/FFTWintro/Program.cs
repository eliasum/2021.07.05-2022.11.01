        ...
        private static void Main()
        {
            ...
            using (BinaryReader br = new BinaryReader(fs))
            {
                try
                {
                    ...
                    // вывод X real и Y imaginary после FFT ///////////////
                    StreamWriter sr2 = new StreamWriter(@"d:\out2.txt");

                    for (int i = 0; i < n; i++)
                        sr2.Write(X_array[i] + "\t\t\t\t" + Y_array[i] + "\n");
                    ...
                    StreamWriter sr3 = new StreamWriter(@"d:\out3.txt");

                    sr3.Write("{0, 15}\t{1, 15}\t{2, 15}\t", "Амплитуда", "Фаза", "Частота\n");

                    for (int i = 0; i < n; i++)
                    {
                        sr3.Write("{0, 15}\t{1, 15}\t{2, 15}\n", A_array[i], phi_proc[i], frec[i]);
                    }

                    sr3.Close();
                    ///////////////////////////////////////////////////////////////////////////////////

                    using (var SW_A_array = new StreamWriter(@"d:\ACH.csv", false, Encoding.Default))
                    {
                    ...
                    // вывод количества максимумов интервалов функции распределения гармоник //////////
                    StreamWriter sr5 = new StreamWriter(@"d:\out5.txt");
                    ...
                    using (var SW_A_array = new StreamWriter(@"d:\Harmonics.csv", false, Encoding.Default))
                    {
                    ...
                    // вывод X real и Y imaginary после FFT из параметров А и Ф////////////////////////
                    for (int i = 0; i < n; i++)
                    {
                    ...
                    StreamWriter sr4 = new StreamWriter(@"d:\out4.txt");

                    for (int i = 0; i < n; i++)
                        sr4.Write(X_array[i] + "\t\t\t\t" + Y_array[i] + "\n");
