...
namespace ESF
{
    internal class Program
    {
        ...
        private static void Main()
        {
            ...
            if (dialog.ShowDialog() == DialogResult.OK)
            {
                ...
                if (bitmap != null && bitmap.Height > options.AveragingWindowLength && bitmap.Width > 0)
                {
                    ...
                    Console.WriteLine("Данные ESF успешно записаны в файл " + OutputFileName + ". Для выхода нажмите любую клавишу...");
                    Console.ReadKey();
                }
                else
                {
        ...
        public static void Compute(Bitmap bitmap)
        {
            ...
            // вывод рассчитанных значений ESF в файл типа .csv__________________________________________________________________
            ...
            */
            ...
            OutputFileName = @"csv\" + output_string + @"_ESF.csv";                // имя файла с данными ESF

            using (var SW_ESF_array = new StreamWriter(OutputFileName, false, Encoding.Default))
            {
                for (int i = 0; i < imageWidth; i++)
