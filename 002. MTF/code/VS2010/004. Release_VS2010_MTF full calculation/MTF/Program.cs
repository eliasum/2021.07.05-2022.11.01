...
namespace MTF
{
    internal class Program
    {
        ...
        private static void Main()
        {
            ...
            if (dialog.ShowDialog() == DialogResult.OK)
            {
                ...
                if (bitmap != null && bitmap.Height > options.AveragingWindowLength && bitmap.Width > 0)
                {
                    ...
                    Console.WriteLine("Данные MTF успешно записаны в файл " + OutputFileName + ". Для выхода нажмите любую клавишу...");
                    Console.ReadKey();
                }
                else
                {
        ...
        public static void Compute(Bitmap bitmap)
        {
            ...
            // формирование имени файла данных MTF
            ...
            */
            ...
            OutputFileName = @"csv\" + output_string + @"_MTF.csv";                // имя файла с данными MTF
            ...
            MTF.HammingWindow(difference);                                         // окно Хемминга
            ...
            using (var SW_MTF_array = new StreamWriter(OutputFileName, false, Encoding.Default))
            {
                for (int i = 0; i < MTF_Length; i++)
