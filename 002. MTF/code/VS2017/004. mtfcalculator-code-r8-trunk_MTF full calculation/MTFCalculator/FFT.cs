...
namespace MTFCalculator
{
    public class FFT
    {
        ...
        public int Direction { get; set; } = FORWARD;
        ...
        {
            /*
                Массив комплексных данных, где каждый k-й элемент - это real часть данных LSF,
                а каждый (k + 1)-й элемент - это imag часть данных LSF, причем imag[] заполнен нулями.
                Соответственно длина массива - удвоенная длина массива real[] данных LSF
            */
        ...
        /// <summary>
        /// Numerical Recipes Fast Fourier Transform (FFT) algorithm.
