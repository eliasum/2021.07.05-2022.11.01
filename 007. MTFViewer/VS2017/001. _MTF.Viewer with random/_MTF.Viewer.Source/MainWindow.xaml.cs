    ...
    public partial class MainWindow : Window
    {
        ...
        private void command_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            switch (((RoutedUICommand)e.Command).Text)
            {
                ...
                // была нажата кнопка "добавить в тренд"
                case "Esf":
                    /*
                    ...
                    */
                    //foreach (Shape item in this.select)
                    {
                        ...
                        /*
                            ...
                            этого же типа
                        */
                        Custom.Shape.Rectangle rectangle = (Custom.Shape.Rectangle)this.select[0];  //item;
                        ...
                        */
                        ...
                        this.viewer.Remove(this.select[0]);   //item;
                    }
                    this.select = null;
                    break;
                case "Lsf":
