        ...
        public static class ESF
        {
            ...
            public static System.Windows.Point[] Compute(Core.Image._8bit.Pixel[,] pixel)
            {
                if (pixel != null)
                {
                    ...
                    Core.Image.ToFile(@"Images\01Source.jpg", source, encoder); 
                    /////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    */
                    ...
                    StreamWriter sr1 = new StreamWriter(@"txt\The brightness of all pixels of the straightened bitmap.txt");
                    ...
                    for (int i = 0; i < imageWidth; i++)
                    {
                        ...
                        {
                            sr1.Write("Width = " + i.ToString("000") + "\t" + "Height = " + j.ToString("000") + "\t"
                                + straightenedBitmap.GetPixel(i, j).GetBrightness().ToString("F9") + "\n");
                        }
                    }
                    ...
                    /*
                    // Алгоритм отсечения близких по значению значений ESF

                    // убрать min и max значения
                    real = real.Where(x => x != real.Min()).ToArray();
                    real = real.Where(x => x != real.Max()).ToArray();

                    realList = realList.Where(x => x != realList.Min()).ToList();
                    realList = realList.Where(x => x != realList.Max()).ToList();
                    ...
                    for (int i = 0; i < real.Length; i++)
                    {
                        if (i < real.Length-1)
                        {
                            if (real[i + 1] - real[i] < 0.0005) real[i]=0;
                        }
                    }
                    ...
                    /*
                    real = null;
                    real = new double[realList.Count];
                    ...
                    */
                    ...
                    /*
                    // Алгоритм фильтрации только растущих значений ESF
                    ...
                    double[] realUp = new double[ind];
                    double[] stepsUp = new double[ind];
                    ...
                    Array.Resize(ref real, ind);
                    Array.Resize(ref steps, ind);
        ...
        public static class LSF
        {
            ...
            public static System.Windows.Point[] Compute(System.Windows.Point[] points)
            {
                if (points != null)
                {
                    ...
                    /*
                    // Алгоритм удаления значений LSF ниже нуля
                    ...
                    double[] difference0 = new double[ind];
                    double[] steps0 = new double[ind];
                    ...
                    Array.Resize(ref difference, ind);
                    Array.Resize(ref steps, ind);
