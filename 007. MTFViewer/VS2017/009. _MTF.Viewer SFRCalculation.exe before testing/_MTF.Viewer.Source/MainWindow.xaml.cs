namespace _MTF.Viewer
{
    ...
    using static _MTF.Viewer.Source.OptionsWindow;
        ...
        private void command_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            switch (((RoutedUICommand)e.Command).Text)
            {
                ...
                case "Esf":
                    ...
                    */
                    foreach (Shape item in this.select)
                    {
                        ...
                        {
                            Command.Custom.Chart.Lsf.Execute(this.chart_ESF.AddPixels(null), null);
                            this.viewer.Remove(item);
                            break;
                        }
                    }
                ...
                case "Options":
                    ...
                    */
                    ow.Owner = this;
                    ow.RaiseCustomEvent += new EventHandler<CustomEventArgs>(ow_RaiseCustomEvent);
                    ow.ShowDialog();
                    break;
            }
        }

        private void ow_RaiseCustomEvent(object sender, CustomEventArgs e)
        {
