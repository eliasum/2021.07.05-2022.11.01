...
#define WM_GET_DATA_PROC                WM_USER+22
...
void ReadSnapInfoFromFile(AnsiString FilePath, SDataMKPTransfer* SData)
{
	...
	TIniFile* ini = new TIniFile(FilePath);
		...
		SData->dUscr = ini->ReadFloat("SnapSettings","dUscr", 10);
		SData->dUmkp = ini->ReadFloat("SnapSettings","dUmkp", 20);
		SData->dUretard = ini->ReadFloat("SnapSettings","dUretard", 30);
		SData->dUacceler = ini->ReadFloat("SnapSettings","dUacceler", 40);
		SData->dUanod = ini->ReadFloat("SnapSettings","dUanod", 50);
		SData->dUmod = ini->ReadFloat("SnapSettings","dUmod", 60);
		SData->dItk = ini->ReadFloat("SnapSettings","dItk", 70);
		SData->dIout = ini->ReadFloat("SnapSettings","dIout", 80);
		SData->dPxel = ini->ReadFloat("SnapSettings","dPxel", 0.012);
		SData->iTypeMkp = ini->ReadInteger("SnapSettings","iTypeMkp", 1);
	delete ini;
