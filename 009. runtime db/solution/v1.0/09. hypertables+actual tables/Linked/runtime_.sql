...
CREATE TABLE table_Glossary (
	...
	FOREIGN KEY (key) REFERENCES NumberActual (NumberActKey), 
	FOREIGN KEY (key) REFERENCES FloatActual (FloatActKey), 
	FOREIGN KEY (key) REFERENCES DecimalActual (DecimalActKey), 
	FOREIGN KEY (key) REFERENCES StringActual (StringActKey)
);
