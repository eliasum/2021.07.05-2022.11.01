...
select * from _Refresh('ControlWorkstation/Equipment/Slot/Item[@key=''30'']/Supply/Item[@key=''Anode'']/Voltage',19);
...
TRUNCATE TABLE table_glossary;
TRUNCATE TABLE table_number;
TRUNCATE TABLE number_actual;
TRUNCATE TABLE table_float;
TRUNCATE TABLE float_actual;
TRUNCATE TABLE table_decimal;
TRUNCATE TABLE decimal_actual;
TRUNCATE TABLE table_string;
TRUNCATE TABLE string_actual;

select * from table_glossary;
select * from number_actual order by key desc;