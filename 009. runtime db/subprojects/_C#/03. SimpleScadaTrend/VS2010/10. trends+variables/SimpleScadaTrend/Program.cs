        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                using (var sw = new StreamWriter("Export.csv", false, Encoding.GetEncoding(65001)))
                {
                    ...
                    sw.WriteLine("..\\;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;");
                    sw.WriteLine(";var1;Single;внутрен.;;;как в настр.;1;выкл.;;;;;;0.##;0;;;по изменению;обычный;0;как в настр.;;;;;по-умолчанию;-1;без фильтра;NAN;NAN;0");
                    sw.WriteLine(";var2;Single;внутрен.;;;как в настр.;1;выкл.;;;;;;0.##;0;;;по изменению;обычный;0;как в настр.;;;;;по-умолчанию;-1;без фильтра;NAN;NAN;1");
                    sw.WriteLine(";var3;Single;внутрен.;;;как в настр.;1;выкл.;;;;;;0.##;0;;;по изменению;обычный;0;как в настр.;;;;;по-умолчанию;-1;без фильтра;NAN;NAN;2");
                }
            }
