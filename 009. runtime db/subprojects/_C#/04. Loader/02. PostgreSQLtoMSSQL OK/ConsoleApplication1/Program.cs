namespace ConsoleApplication1
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string pathToFile = "..\\..\\stylesheet.txt";
                        ...
                        do
                        {
                            ...
                            for (int i = 0; i < valuesPostgres.Length; i++)
                            {
                                ...
                                using (NpgsqlCommand command = new NpgsqlCommand(
                                    //"INSERT INTO public.integer_actual(key, fix, value) VALUES(" + i + ", NOW(), " + rnd.Next(0, 100) + ");", connectionPostgr))
                            ...
                            try
                            {
                                ...
                                for (int i = 0; i < valuesPostgres.Length; i++)
                                {
                                    ...
                                    //command.CommandText = "INSERT [scada].[dbo].[trends_data] VALUES (" + i + ", CURRENT_TIMESTAMP, " + rnd.Next(0, 100) + ", 1)";
