        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            if (File.Exists(args0))
            {
                ...
                // контекст данных
                XmlNodeList nodes = xRoot.SelectNodes("//Amperage | //Voltage | //Item/Temperature | //Time | //Rate | //State | //Termodat/Status/Temperature");
                ...
                XmlNodeList nodesTs = xRoot.SelectNodes("//Time");
                XmlNodeList nodesR = xRoot.SelectNodes("//Rate");
                XmlNodeList nodesState = xRoot.SelectNodes("//State");
                XmlNodeList nodesStatus = xRoot.SelectNodes("//Termodat/Status/Temperature");
